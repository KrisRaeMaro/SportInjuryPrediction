...
## Overview
Scripts and notebooks for exploring, preprocessing, and modeling injury prediction in athletes using machine learning pipelines. The goal is to analyze the dataset, preprocess it for machine learning, and build predictive models using XGBoost and CNNs. Below is an explanation of the files included in this project.
